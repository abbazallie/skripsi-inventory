...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 09, 2021 at 03:03 PM
...
(1, 'Ali Basalamah', 'abbaz', '$2y$10$9a81OrZssI5htWHMAtAkZeGFCzLWWRKbsGmoyuxTPalMjbISCISFy', 'admin', '2021-08-09 05:32:51', '2021-08-09 05:32:51');
...
ALTER TABLE `users`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `users_user_unique` (`username`),
...
--
ALTER TABLE `peminjaman`
  ADD CONSTRAINT `peminjaman_brg_id_foreign` FOREIGN KEY (`barang_id`) REFERENCES `barang` (`id`);
COMMIT;
